...
public final class LexiconProto {
  ...
  public interface DictionaryItemOrBuilder extends
     ...
     * @return The enum numeric value on the wire for primaryPos.
     */
     ...
     * @return The enum numeric value on the wire for secondaryPos.
     */
    int getSecondaryPosValue();
    /**
     * <code>.SecondaryPos secondary_pos = 6;</code>
     * @return The secondaryPos.
     */
     ...
     * @return The enum numeric value on the wire of rootAttributes at the given index.
     */
  ...
  private static final long serialVersionUID = 0L;
     ...
     * @return The enum numeric value on the wire for primaryPos.
     */
    @java.lang.Override public int getPrimaryPosValue() {
      return primaryPos_;
    }
    /**
     * <code>.PrimaryPos primary_pos = 5;</code>
     * @return The primaryPos.
     */
    @java.lang.Override public zemberek.morphology.lexicon.proto.LexiconProto.PrimaryPos getPrimaryPos() {
     ...
     * @return The enum numeric value on the wire for secondaryPos.
     */
    @java.lang.Override public int getSecondaryPosValue() {
     ...
     * @return The secondaryPos.
     */
    @java.lang.Override public zemberek.morphology.lexicon.proto.LexiconProto.SecondaryPos getSecondaryPos() {
      @SuppressWarnings("deprecation")
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (primaryPos_ != other.primaryPos_) return false;
      if (secondaryPos_ != other.secondaryPos_) return false;
      if (!rootAttributes_.equals(other.rootAttributes_)) return false;
      if (getIndex()
  ...
  checkByteStringIsUtf8(value);
      ...
      /**
       * <code>.PrimaryPos primary_pos = 5;</code>
       * @param value The enum numeric value on the wire for primaryPos to set.
       * @return This builder for chaining.
       */
      ...
      /**
       * <code>.PrimaryPos primary_pos = 5;</code>
       * @param value The primaryPos to set.
       * @return This builder for chaining.
       */
      ...
      /**
       * <code>.SecondaryPos secondary_pos = 6;</code>
       * @param value The enum numeric value on the wire for secondaryPos to set.
       * @return This builder for chaining.
       */
      ...
      /**
       * <code>.SecondaryPos secondary_pos = 6;</code>
       * @param value The secondaryPos to set.
       * @return This builder for chaining.
       */
       ...
       * @param value The rootAttributes to set.
       * @return This builder for chaining.
       */
      ...
      /**
       * <code>repeated .RootAttribute root_attributes = 7;</code>
       * @param value The rootAttributes to add.
       * @return This builder for chaining.
       */
      ...
      /**
       * <code>repeated .RootAttribute root_attributes = 7;</code>
       * @param values The rootAttributes to add.
       * @return This builder for chaining.
       */
      ...
      /**
       * <code>repeated .RootAttribute root_attributes = 7;</code>
       * @param value The enum numeric value on the wire for rootAttributes to add.
       * @return This builder for chaining.
       */
      ...
      /**
       * <code>repeated .RootAttribute root_attributes = 7;</code>
       * @param values The enum numeric values on the wire for rootAttributes to add.
       * @return This builder for chaining.
       */
  ...
  public interface DictionaryOrBuilder extends
     ...
     *
     * <code>string generation_time = 2;</code>
     * @return The bytes for generationTime.
     */
    com.google.protobuf.ByteString
  ...
  private static final long serialVersionUID = 0L;
    ...
    throw new NullPointerException();
       ...
       *
       * <code>string generation_time = 2;</code>
       * @param value The bytes for generationTime to set.
       * @return This builder for chaining.
       */
