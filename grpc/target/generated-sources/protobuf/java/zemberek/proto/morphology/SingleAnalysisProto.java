...
private static final long serialVersionUID = 0L;
  ...
  protected java.lang.Object newInstance(
    ...
    return new SingleAnalysisProto();
  }
   ...
   * @return Whether the dictionaryItem field is set.
   */
  @java.lang.Override
   ...
   * @return A list containing the lemmas.
   */
   ...
   * @return The lemmas at the given index.
   */
   ...
   * @return The bytes of the lemmas at the given index.
   */
  public com.google.protobuf.ByteString
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (hasDictionaryItem() != other.hasDictionaryItem()) return false;
    if (hasDictionaryItem()) {
      if (!getDictionaryItem()
          .equals(other.getDictionaryItem())) return false;
    }
    if (!getAnalysis()
        .equals(other.getAnalysis())) return false;
    if (getInformal()
        != other.getInformal()) return false;
    if (getRuntime()
        != other.getRuntime()) return false;
    if (!getLemmasList()
        .equals(other.getLemmasList())) return false;
    if (!getMorphemesList()
  ...
  checkByteStringIsUtf8(value);
     ...
     *
     * <code>bool informal = 4;</code>
     * @param value The informal to set.
     * @return This builder for chaining.
     */
  ...
  ensureLemmasIsMutable();
     ...
     *
     * <code>repeated string lemmas = 6;</code>
     * @param values The lemmas to add.
     * @return This builder for chaining.
     */
     ...
     *
     * <code>repeated string lemmas = 6;</code>
     * @param value The bytes of the lemmas to add.
     * @return This builder for chaining.
     */
